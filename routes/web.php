...
use App\Http\Controllers\Transaction\ApprovalController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profile/signature', [ProfileController::class, 'signature'])->name('profile.signature.show');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/sales-orders/{salesOrder}/upload-dokumen', [SalesOrderController::class, 'uploadDokumen'])->middleware('permission:input_sales_order')->name('sales-orders.upload-dokumen');
    Route::get('/sales-order-documents/{document}/download', [SalesOrderController::class, 'downloadDokumen'])->middleware('permission:lihat_sales_order')->name('sales-order-documents.download');
...
Route::middleware(['auth', 'permission:lihat_jabatan'])->group(function () {
    ...
    Route::post('/settings', [SettingsController::class, 'update'])->middleware('permission:ubah_jabatan')->name('settings.update');
