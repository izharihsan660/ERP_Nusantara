...
<table class="box"><tr><td style="width:55%"><div class="company">PT NUSANTARA ABADI JAYA</div><div>JL.Wiyata No.81 RT23</div><div>Kalimantan Timur</div></td><td><div class="title">INVOICE</div><table><tr><td style="border:0;width:70px">No</td><td style="border:0">: {{ $invoice->no_dokumen }}</td></tr><tr><td style="border:0">Tanggal</td><td style="border:0">: {{ $invoice->tgl_dokumen?->translatedFormat('d F Y') ?? '-' }}</td></tr></table></td></tr></table>
